...
#### Spring Data JPA
Spring Data Mongo allows you to create repositories for your data without even having to write a lot of code. The only code you need is a simple interface that extends from another interface and then you're done.
...
```
cd target
java -jar spring-rest-mongo.jar
```
